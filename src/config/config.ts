...
if(env === 'development') {
  ...
  process.env.APP_TOKEN           = process.env.DEV_APP_TOKEN
  process.env.ADMIN_TOKEN         = process.env.DEV_ADMIN_TOKEN
  ...
  process.env.APP_TOKEN           = process.env.TEST_APP_TOKEN
  process.env.ADMIN_TOKEN         = process.env.TEST_ADMIN_TOKEN
